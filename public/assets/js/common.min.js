(function (e) {
    ...
    e(window).on("load", function () {
        e("body").imagesLoaded({}, function () {
            var t = e(".preloader");
            t.addClass("loaded"), t.find(".centrize").fadeOut(), n(), e(".scroll-animate").scrolla({
                once: !0,
                mobile: !0
            })
        })
        ...
        s = e.cookie("skin"), s === "dark" && e("body").removeClass("light-skin"), s === "light" && e("body").addClass("light-skin"), e("body").hasClass("light-skin") && e(".header .switcher-btn").addClass("active"), e(".header").on("click", ".switcher-btn", function () {
            ...
            if (e(this).hasClass("active")) e(this).removeClass("active"), e(this).addClass("no-touch"), e("body").removeClass("no-scroll"), e(".menu-full-overlay").removeClass("is-open"), e(".menu-full-overlay").removeClass("has-scroll"), e(".menu-full-overlay").removeClass("animate-active"), setTimeout(function () {
                ...
                e(".menu-full-overlay").css({height: t}), e("body").addClass("no-scroll"), e(".menu-full-overlay").addClass("is-open visible"), setTimeout(function () {
        ...
        }), o = e(".m-gallery"), o.imagesLoaded(function () {
            o.isotope({itemSelector: ".col-lg-6", percentPosition: !0})
        }), e(".filter-links").on("click", "a", function () {
            var t = e(this).attr("data-href");
            return n.isotope({filter: t}), e(".filter-links a").removeClass("active"), e(this).addClass("active"), e(t).find(".scroll-animate").hasClass("animate__active") || e(t).find(".scroll-animate").addClass("animate__active"), !1
    ...
    function n() {
        var n = window.innerWidth / 2, s = window.innerHeight / 2, t = {
            el: e(".cursor"),
            ...
            h: 30,
            update: function () {
                var e = this.x - this.w / 2, t = this.y - this.h / 2;
    ...
    function t() {
        var n = e(window).width(), t = e(window).height();
        e(".error-page, .menu-full-overlay, .preloader .centrize").css({height: t})
    }
})(jQuery)
